...
public:
    ...
    // Only accepts an angle in the range of -180.0 to 180.0 (will clamp, otherwise).
    static s32 deg2idx(T a)
    {
        return a * cHalfRoundIdx / 180.0f;
    }
    ...
    // Only returns in the range of -180.0 to 180.0.
