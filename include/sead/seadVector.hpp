...
#include "sead/seadVectorCalcCommon.h"
...
{
    Vector2CalcCommon<T>::set(*this, v, v);
}
...
template <typename T>
Vector2<T>::operator nn::math::VEC2() const
{
    return nn::math::VEC2{this->x, this->y};
}
...
{
    Vector3CalcCommon<T>::set(*this, v, v, v);
}
...
template <typename T>
Vector3<T>::operator nn::math::VEC3() const
{
    return nn::math::VEC3{this->x, this->y, this->z};
}
...
{
    Vector4CalcCommon<T>::set(*this, v, v, v, v);
}
...
template <typename T>
Vector4<T>::operator nn::math::VEC4() const
{
    return nn::math::VEC4{this->x, this->y, this->z, this->w};
}
